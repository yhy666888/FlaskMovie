...
from app.models import User, UserLog, Preview, Movie, Tag, Comment, MovieCollect
...
def play(movie_id=None, page=None):
    ...
    if form.validate_on_submit() and 'login_user' in session:
        ...
        return redirect(url_for('home.play', movie_id=movie_id, page=1))
